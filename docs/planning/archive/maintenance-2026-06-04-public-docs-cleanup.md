...
documentation from private/shared operations material. The public repository
now focuses on reproducible local development, methodology, limitations, public
...
- Preserved ignored local `private/` copies for convenience while moving the
  durable private record to the private/shared operations source of truth.
