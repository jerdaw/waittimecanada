...
describe('DataExport', () => {
  ...
  it('renders with default state', () => {
    ...
    expect(screen.getByText(/Export wait time data with full methodology tags/i)).toBeInTheDocument();
  ...
  it('displays citation information', () => {
    ...
    expect(screen.getByText(/WaitTime Canada.*2026.*Canadian ER Wait Time Data/i)).toBeInTheDocument();
